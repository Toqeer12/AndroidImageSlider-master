 ...
 */
public class LeadingRun extends Fragment {
    Intent i;
    String id;
    ...
    public String url= Constants.leadingrun;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        id = "2";
        View view = inflater.inflate(R.layout.leadingrun, container,
                false);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    contacts = jsonObj.getJSONArray("LeadingRun");
...
//                            title.setVisibility(View.GONE);
                        Object.add(new BestBowlingModel(playername,match, run, avg,sr, four, six));
