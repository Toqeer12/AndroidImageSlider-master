 ...
 */
public class BestBowling extends Fragment {
        Intent i;
        String id;
    ...
    ServiceHandler sh;
        ...
        public String url= Constants.bestbowl;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        id = "2";
        View view = inflater.inflate(R.layout.bestbowling, container,
                false);
        list=(ListView)view.findViewById(R.id.bestbowling);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    contacts = jsonObj.getJSONArray("BestBowl");
