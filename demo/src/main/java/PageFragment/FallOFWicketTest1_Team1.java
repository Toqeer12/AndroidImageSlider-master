 ...
 */
public class FallOFWicketTest1_Team1 extends Fragment {
    ...
    public FallOFWicketTest1_Team1() {
...
//                    adapterBattingTeamTwo=new FallOFWicketAdapter(getActivity(),battingTeamTwoList);
//                    FallOFWicketTest1_Team2.battingTeamTwoListView.setAdapter(adapterBattingTeamTwo);
                    if (id.equalsIgnoreCase("0")){
                        PagerAdapterFallofWicketsTest.tabTitles[0] = name;
                        FallOFWickets.tabs.setViewPager(FallOFWickets.pager);
//
