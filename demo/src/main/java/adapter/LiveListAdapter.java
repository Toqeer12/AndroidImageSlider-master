...
public class LiveListAdapter extends BaseAdapter {
    ...
    public LiveListAdapter(Context context, ArrayList<LivelistItem> object) {
...
//        LinearLayout left;
        ...
        rowView = inflater.inflate(R.layout.livelistdemo, null);
        ...
        try {
            ...
            Date date2 = sdf2.parse(temp.date);
...
//		    String [] splitted = your_format.split(" ");
        ...
        try {
            ...
            Date date = sdf.parse(temp.date);
            System.out.println(date);
            your_format = new SimpleDateFormat("MMM dd , yyyy").format(date);
            String [] splitted = your_format.split(" ");
            System.out.println(your_format);    //The second part of the splitted string, i.e time

        } catch (Exception e) {
            e.printStackTrace(); //date format error
        }

        holder.type.setText(your_format+"    "+your_format2);
